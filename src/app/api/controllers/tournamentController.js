...
const createTournament = async (req, res) => {
    ...
    let {t_name, g_id, e_id, h_id, t_id, participantCap, registrationDeadline} = req.body;
    ...
    try {
      const result = await tournamentService.createTournament(t_name, g_id, e_id, h_id, t_id, participantCap, registrationDeadline);
